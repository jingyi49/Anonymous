...
class Encoder(torch.nn.Module):
    def __init__(self, h):
        ...
        self.latent_output_conv = weight_norm(Conv1d(h.AMP_Encoder_channel//2, h.latent_dim, h.latent_output_conv_kernel_size, 1, 
...
class Decoder(torch.nn.Module):
    def __init__(self, h):
        ...
        self.latent_input_conv = weight_norm(Conv1d(h.latent_dim, h.AMP_Decoder_channel//2, h.latent_input_conv_kernel_size, 1, 
                                                 padding=get_padding(h.latent_input_conv_kernel_size, 1)))

        self.AMP_Decoder_upsample_input_conv = weight_norm(ConvTranspose1d(h.AMP_Decoder_channel//2, h.AMP_Decoder_channel,
        ...
        #out_dim = h.n_fft + 2
        self.out_logamp = torch.nn.Linear(self.dim, h.AMP_Encoder_channel)
        self.AMP_Decoder_output_conv = weight_norm(Conv1d(h.AMP_Decoder_channel, h.num_mels, h.AMP_Decoder_output_conv_kernel_size, 1,
